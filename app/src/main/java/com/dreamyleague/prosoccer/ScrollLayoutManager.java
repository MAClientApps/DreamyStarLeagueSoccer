package com.dreamyleague.prosoccer;
...
public class ScrollLayoutManager extends RecyclerView.LayoutManager  {
    ...
    public ScrollLayoutManager(Context context, int itemSpace) {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        LinearSmoothScroller smoothScroller = new LinearSmoothScroller(context) {
            ...
            public PointF computeScrollVectorForPosition(int targetPosition) {
                return ScrollLayoutManager.this.computeScrollVectorForPosition(targetPosition);
            }
        };
